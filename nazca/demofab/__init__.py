...
An example on how to initialize foundry specific technology settings.
DEMO PDK is for Nazca tutorials and PIC design training.

Note:
    Any resemblence of technology details in the DEMO PDK with an actual foundry
